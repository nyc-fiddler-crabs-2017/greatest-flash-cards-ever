...
Guess.create(user_input: "Montgomery", card_id: 1, round_id: 1)
Guess.create(user_input: "Tallahassee", card_id: 2, round_id: 1)
Guess.create(user_input: "Juneau", card_id: 3, round_id: 1)
Guess.create(user_input: "Helena", card_id: 4, round_id: 1)
Guess.create(user_input: "Salem", card_id: 5, round_id: 1)
Guess.create(user_input: "Atlanta", card_id: 6, round_id: 1)
Guess.create(user_input: "Pierre", card_id: 7, round_id: 1)
Guess.create(user_input: "Montpelier", card_id: 8, round_id: 1)
Guess.create(user_input: "Salt Lake City", card_id: 9, round_id: 1)
Guess.create(user_input: "Olympia", card_id: 10, round_id: 1)

Guess.create(user_input: "tiger", card_id: 11, round_id: 2)
Guess.create(user_input: "peacock", card_id: 12, round_id: 2)
Guess.create(user_input: "4", card_id: 13, round_id: 2)
Guess.create(user_input: "ostrich", card_id: 14, round_id: 2)
Guess.create(user_input: "whale shark", card_id: 15, round_id: 2)
Guess.create(user_input: "black marlin", card_id: 16, round_id: 2)
Guess.create(user_input: "dog", card_id: 17, round_id: 2)
Guess.create(user_input: "mouse", card_id: 18, round_id: 2)
Guess.create(user_input: "hi alex", card_id: 19, round_id: 2)
Guess.create(user_input: "dog", card_id: 20, round_id: 2)
Guess.create(user_input: "hummingbird", card_id: 12, round_id: 2)
Guess.create(user_input: "cheetah", card_id: 14, round_id: 2)
Guess.create(user_input: "cat", card_id: 18, round_id: 2)
